    ...
    <div id="carouselExampleFade" className="carousel slide carousel-fade" data-bs-ride="carousel">
      <div className="carousel-inner">
        <div className="carousel-item active">
          <img src="https://picsum.photos/1200/500?blur=7&random=1" className="d-block w-100" alt="Slide 1" />
          ...
          <div className="carousel-caption d-none d-md-block">
            ...
            <Link to="/signup" className="btn btn-outline-light btn-lg mx-2">Let's Get Started</Link>
          </div>
        </div>
        <div className="carousel-item">
          {/* <img src={carousal1} style={{ width: '1200px', height: '500px', objectFit: 'cover' }} className="d-block w-100" alt="Slide 2" /> */}
          <img src="https://picsum.photos/1200/500?blur=7&random=2" className="d-block w-100" alt="Slide 2" />
        ...
        <div className="carousel-item">
          <img src="https://picsum.photos/1200/500?blur=7&random=3" className="d-block w-100" alt="Slide 3" />
